...
rfm_segmentation/
│
├── rfm_engine.py          # The core pipeline script
├── .gitignore             # Shields environment and output files
├── README.md              # Project documentation
│
└── outputs/               # Auto-generated by the script (Git ignored)
    ├── rfm_results.csv    # Final segmented database
    └── figures/           # Rendered charts (scatter, heatmap)
